...
use stm32f4xx_hal::pac::{spi1, RCC, SPI1, SPI2};
...
#[cfg(feature = "spi4")]
use stm32f4xx_hal::pac::SPI4;

#[cfg(feature = "spi5")]
use stm32f4xx_hal::pac::SPI5;

#[cfg(feature = "spi6")]
use stm32f4xx_hal::pac::SPI6;
...
use stm32f4xx_hal::gpio::gpioa::{PA1, PA11};
#[cfg(any(
    feature = "stm32f410",
    feature = "stm32f411",
    feature = "stm32f412",
...
use stm32f4xx_hal::gpio::gpioa::{PA10, PA12};
...
use stm32f4xx_hal::gpio::gpiob::{PB10, PB13, PB14, PB15, PB3, PB4, PB5};

#[cfg(any(feature = "stm32f446", feature = "stm32f469", feature = "stm32f479"))]
use stm32f4xx_hal::gpio::gpioc::PC1;
#[cfg(any(
    feature = "stm32f410",
    feature = "stm32f411",
    feature = "stm32f412",
...
use stm32f4xx_hal::gpio::gpioc::{PC2, PC3};

#[cfg(any(feature = "stm32f446"))]
use stm32f4xx_hal::gpio::gpiod::PD0;
#[cfg(any(
    feature = "stm32f401",
    feature = "stm32f411",
    feature = "stm32f412",
...
use stm32f4xx_hal::gpio::gpiod::{PD3, PD6};
...
use stm32f4xx_hal::gpio::gpioe::{PE12, PE13, PE14, PE2, PE5, PE6};
...
use stm32f4xx_hal::gpio::gpiof::{PF11, PF7, PF8, PF9};

#[cfg(any(feature = "stm32f446"))]
use stm32f4xx_hal::gpio::gpiog::PG11;
#[cfg(any(
    feature = "stm32f427",
    feature = "stm32f429",
    feature = "stm32f437",
...
use stm32f4xx_hal::gpio::gpiog::{PG12, PG13};
...
use stm32f4xx_hal::gpio::gpioh::{PH6, PH7};
...
use stm32f4xx_hal::gpio::gpioi::{PI1, PI2, PI3};
